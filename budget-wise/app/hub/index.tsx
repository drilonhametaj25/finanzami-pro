...
export default function HubScreen() {
  ...
  useEffect(() => {
    ...
    const healthInput = {
      ...
      hasMultipleIncomes: false, // Would need to track this
    };
    ...
    const achievementStats = {
      ...
      monthsUnderBudget: 0, // Would need history
      ...
      subscriptionsManaged: 0, // Would need from store
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]} edges={['bottom']}>
        ...
        <SafeAreaView edges={['top']}>
          <View style={styles.headerContent}>
            <View style={styles.headerIconContainer}>
              <MaterialCommunityIcons name="view-dashboard" size={28} color="#FFFFFF" />
            </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.statsGrid}>
          <Pressable onPress={() => router.push('/patrimonio')}>
          ...
          <Pressable onPress={() => router.push('/hub/simulator')}>
            <Surface style={styles.statCard} elevation={1}>
        ...
        <Card style={styles.card} mode="elevated">
          <Card.Content>
            ...
            {monthlyStats.budgetUsed > 80 && monthlyStats.budgetUsed < 100 && (
              <View style={[styles.predictionItem, { backgroundColor: brandColors.warning + '15', padding: 12, borderRadius: 8 }]}>
                <MaterialCommunityIcons name="alert" size={20} color={brandColors.warning} />
